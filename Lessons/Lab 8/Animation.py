...
for i in range(50):
    x = random.randrange(260, 360)
    y = random.randrange(150, 235)
...
while not done:
    ...
    for i in range(len(snow_list)):
        ...
        if snow_list[i][1] > 240:
            # Reset it just above the top
            y = random.randrange(102, 150)
            snow_list[i][1] = y
    ...
    # Wall colored square to block snow flakes forming
    pygame.draw.rect(screen, [173, 114, 114], [250, 100, 125, 50])
